# The name of this view in Looker is "Actifio Onvault"
view: actifio_onvault {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `actifio_reports.actifio_onvault`
    ;;
  ...
  dimension: pre_compress_gb_ {
    type: number
    sql: ${TABLE}.PreCompress_GB_ ;;
  }
  ...
  dimension: target_pool {
    type: string
    sql: ${TABLE}.TargetPool ;;
  }
